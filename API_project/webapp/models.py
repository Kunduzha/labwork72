...
class Article(models.Model):
    text = models.TextField(max_length=2000, null=False, blank=False, verbose_name='Цитата', validators=(MinLengthValidator(5),))
    name = models.CharField(max_length=50, null=True)
    email = models.EmailField(max_length=100, blank=False, null=False, verbose_name='почтовый адрес')
    rating = models.IntegerField(verbose_name='rate', null=False, blank=False, default=0)
